      ...
      <div className="h-auto w-full bg-white/50">
        ...
        <div className="grid-container2 pt-32 xl:mx-32 lg:mx-32 mx-3 justify-center">
          ...
          <div className="w-auto h-auto mx-12 space-y-3 mt-6">
            ...
            <div className="flex">
            <FcRadarPlot size={28} className="mx-2"/> <h1 className="xl:text-xl">Dominio.cl</h1>
            </div>
            <div className="flex">
            <FcFeedback size={28} className="mx-2"/> <h1 className="xl:text-xl">10 Correos Corporativos</h1>
            </div>
            <div className="flex">
            <FcLock size={28} className="mx-2"/> <h1 className="xl:text-xl">Certificado SSL</h1>
            </div>
            <div className="flex">
            <FcComments size={28} className="mx-2"/> <h1 className="xl:text-xl">Formulario de Contacto</h1>
            </div>
            <div className="flex">
            <FcServices size={28} className="mx-2"/> <h1 className="xl:text-xl">Panel Administrativo</h1>
            </div>
            <div className="flex">
            <FcAssistant size={28} className="mx-2"/> <h1 className="xl:text-xl">Soporte Online</h1>
            </div>
          ...
          <div className="w-auto h-auto mx-12 space-y-3 mt-6">
            ...
            <div className="flex">
            <FcRadarPlot size={28} className="xl:mx-2"/> <h1 className="xl:text-xl">Dominio.cl/.com</h1>
            </div>
            <div className="flex">
            <FcFeedback size={28} className="xl:mx-2"/> <h1 className="xl:text-xl">40 Correos Corporativos</h1>
            </div>
            <div className="flex">
            <FcLock size={28} className="mx-2"/> <h1 className="xl:text-xl">Certificado SSL</h1>
            </div>
            <div className="flex">
            <FcComments size={28} className="xl:mx-2"/> <h1 className="xl:text-xl">Formulario de Contacto</h1>
            </div>
            <div className="flex">
            <FcServices size={28} className="xl:mx-2 xl:mt-4"/> <h1 className="xl:text-xl">Panel Administrativo 100% Personalizado</h1>
            </div>
            <div className="flex">
            <FcAssistant size={28} className="xl:mx-2"/> <h1 className="xl:text-xl">Soporte Online</h1>
            </div>
