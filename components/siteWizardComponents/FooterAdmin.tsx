...
import { IoLogoFacebook, IoLogoInstagram, IoLogoWhatsapp, IoMdMail } from 'react-icons/io'
...
function FooterAdmin({}: Props) {
  return (
    ...
    <h1 className="lg:text-4xl text-blue-400 no-select lg:pb-4 font-kanit">Acerca de nosotros</h1>
             <h2 className="lg:text-md text-white font-roboto">SiteWizard & XplenDev, Liderado por Luis Rivera Araya, creamos sitios web</h2>
   ...
   <h1 className="lg:text-4xl text-blue-400 font-kanit">Información</h1>
             <div className="h-auto w-[210px] lg:py-4">
              <Link href={''} className="">
               <h2 className="lg:text-md font-roboto text-white transition-all hover:scale-105 border-b border-transparent hover:border-blue-500 hover:text-blue-500">XplenDev</h2>
              </Link>
              <Link href={''}>
   ...
   <div className="flex space-x-4 text-center items-center justify-center pt-2">
        ...
        <div className="text-center pt-2">
          <h1 className="text-white font-roboto">© 2023 SiteWizard & XplenDev | Code By Luis Rivera Araya</h1>
        </div>
