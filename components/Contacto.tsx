...
function Contacto({}: Props) {
  ...
  return (
    <div className="inline:block h-screen w-screen bg-fixed bg-center bg-cover fondo-img7 z-0 font-principal">
      ...
      <div className="xl:h-[850px] h-screen object-center">
        ...
        <div className="flex xl:w-[620px] md:w-[580px] w-[500px] my-12 mx-auto rounded-xl">
          ...
          <div className="w-full h-[80px] inline-block xl:mt-10 text-center my-auto">
            <h1 className="font-principal xl:text-4xl text-xl text-[#ED1FE8]"> Hablemos! </h1>
            <h2 className="mt-2 font-principal xl:text-xl text-md text-blue-950">Cuéntanos tu idea y te responderemos lo antes posible</h2>
          </div>
