...
function Inicio({ }: Props) {
  return (
    <motion.div className="flex items-center justify-center h-screen w-screen bg-center bg-cover fondo-img5 z-0
    ">
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-black/50 h-screen w-screen shadow-xl border-b-4 border-[#ED1FE8]"></div>
        <div className="relative flex h-full w-screen m-4 ml-5">
             ...
             <div className="relative h-full w-[1100px]">
              ...
              <div className="absolute w-full h-full">
                ...
                <h1 className="text-center text-5xl mb-6 cursor-default hover:scale-105 transition duration-200 ease-in-out"> <motion.span className="text-white hover:text-yellow-400 cursor-default hover:scale-105 transition duration-150 ease-in-out">Diseño y
                     ...
                     <h2 className="py-5 text-xl cursor-default">Bienvenido a  <span className="text-2xl text-[#ED1FE8] cursor-default"> XplenDevelopers
