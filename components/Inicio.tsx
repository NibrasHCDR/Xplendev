...
function Inicio({ }: Props) {
  return (
    <motion.div className="flex items-center justify-center h-screen w-screen bg-center bg-cover fondo-img5 z-0 shadow-xl">
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-black/50 h-screen w-screen"></div>
          ...
          <div className="absolute mt-32 flex h-[950px] w-full">
             ...
             <div className="relative h-full w-[1100px]">
              ...
              <div className="absolute w-full h-full">
                ...
                <div className="block w-full h-auto text-white xl:mt-52 lg:mt-32 md:mt-28 mt-10 mx-auto">
                     
                <h1 className="text-center text-5xl mb-6 font-mono cursor-default hover:scale-105 transition duration-200 ease-in-out"> <motion.span className="text-white hover:text-yellow-400 cursor-default hover:scale-105 transition duration-150 ease-in-out">Diseño y
                     ...
                     <h2 className="py-5 text-xl cursor-default">Bienvenido a  <span className="text-2xl font-semibold text-[#ED1FE8] cursor-default"> XplenDevelopers
                     ...
                     <button type="button"
                        className="xl:mt-12 xl:text-2xl text-xl center grid mx-auto hover:scale-110 hover:animate-pulse rounded-full hover:text-[#ED1FE8] border-4 border-white hover:border-[#ED1FE8] px-6 pb-[6px] pt-2 font-medium uppercase leading-normal transition duration-150 ease-in-out hover:border-primary-600 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-primary-600 focus:border-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:border-primary-700 active:text-primary-700 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10 font-mono shadow-md shadow-[#ED1FE8]"
